...
- `AGENT_EMOJI`: Special marker emoji for agent comments. Defaults to `🤖`.
...
6. Perform a quick code review using the `feature-review` skill.
7. Create and link a pull request.
8. Leave a final comment with PR link.
...
Invoke the  `feature-review` skill for a light review.
