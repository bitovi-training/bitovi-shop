...
1. Refine the idea with the user using a **MINIMUM OF 5** targeted questions addressing high level usability and edge case scenarios, while doing very limited lightweight repo research (if appropriate).
